...
- **Pricing Matrix System:**
  - **Aluminium Scaffolding:** Dynamic pricing organized by width (0.7m Single/1.4m Double) and height (2m-16m). Admins set separate buy and rent prices for each width/height combination via dedicated pricing matrix admin panel accessible from navbar.
  - **H-Frames:** Pricing organized by quantity sets (1, 5, 10, 20, 30, 40, 50, 75, 100, 150, 200 sets). Admins manage buy and rent prices for each set quantity across all H-Frame products via dedicated navbar button. No discount tiers - simple buy/rent pricing model.
  - **Accessories:** Simple buy/rent pricing for each accessory product. Admins manage pricing for all accessories in dedicated pricing matrix panel accessible from navbar.
