...
- **Deposit System:** Rental products (all categories except Cuplock) support admin-configurable deposit amounts. Deposits are visible to users only when "Rent" purchase type is selected. Admin panel displays deposit as the 3rd field (after Buy and Rent) in product forms and pricing matrices.
